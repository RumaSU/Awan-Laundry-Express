...
$('.btn-sveServcShipping').click((e) => {
    ...
    const VAL_PRC = $ELEMN_THS.find('#inpServiceStorePriceShipping').val();
    const VAL_ACTV = $ELEMN_THS.find('#actvThsShippingServc').is(':checked') ? 1 : 0;
    
    let dataAjax = {
        'inpServiceStorePriceShipping': VAL_PRC,
        'actvThsShippingServc': VAL_ACTV,
    }
