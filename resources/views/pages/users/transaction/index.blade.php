...
@section('head-style-field')
    <style>
        ...
        .cCTransactionItm .imageTransaction {
            aspect-ratio: 16 / 9;
        }
        .txTimeTras {
            font-size: 0.65rem;
...
@section('main-content-user')
    ...
    <div class="ctr-Transaction mt-8">
        <div class="cTransaction">
            <div class="ctr-headTransaction">
                <div class="cHeadTransaction">
                    <div class="titleTransaction ml-[10%]">
                        <div class="tx text-xl font-bold">
                            <h2>Riwayat Transaksi</h2>
                        </div>
                    </div>
                    <div class="ctr-listFilterTransaction mt-4 ml-[5%]">
                        <div class="cListFilterTransaction selectDisable flex flex-wrap items-center gap-2 font-bold">
                            <div class="ctr-filterItm">
                                <div class="cFilterItm">
                                    <input type="radio" name="filterTransaction" id="filterItmAllTransaction" class="peer/allTransaction hidden sr-only" checked>
                                    <label for="filterItmAllTransaction" class="block cursor-pointer border px-6 md:px-8 xl:px-10 py-2 rounded-full transition-all duration-300 border-gray-400 hover:bg-[#FF3377] hover:text-white hover:border-pink-900 peer-checked/allTransaction:bg-[#FF3377] peer-checked/allTransaction:text-white peer-checked/allTransaction:border-pink-900">
                                        <div class="cFAllTransaction">
                            ...
                            <div class="ctr-filterItm">
                                <div class="cFilterItm">
                                    <input type="radio" name="filterTransaction" id="filterItmDoneTransaction" class="peer/DoneTransaction hidden sr-only">
                                    <label for="filterItmDoneTransaction" class="block cursor-pointer border px-6 md:px-8 xl:px-10 py-2 rounded-full transition-all duration-300 border-gray-400 hover:bg-[#FF3377] hover:text-white hover:border-pink-900 peer-checked/DoneTransaction:bg-[#FF3377] peer-checked/DoneTransaction:text-white peer-checked/DoneTransaction:border-pink-900">
                                        <div class="cFDoneTransaction">
                            ...
                            <div class="ctr-filterItm">
                                <div class="cFilterItm">
                                    <input type="radio" name="filterTransaction" id="filterItmPieceTransaction" class="peer/PieceTransaction hidden sr-only">
                                    <label for="filterItmPieceTransaction" class="block cursor-pointer border px-6 md:px-8 xl:px-10 py-2 rounded-full transition-all duration-300 border-gray-400 hover:bg-[#FF3377] hover:text-white hover:border-pink-900 peer-checked/PieceTransaction:bg-[#FF3377] peer-checked/PieceTransaction:text-white peer-checked/PieceTransaction:border-pink-900">
                                        <div class="cFPieceTransaction">
                            ...
                            <div class="ctr-filterItm">
                                <div class="cFilterItm">
                                    <input type="radio" name="filterTransaction" id="filterItmShippingTransaction" class="peer/ShippingTransaction hidden sr-only">
                                    <label for="filterItmShippingTransaction" class="block cursor-pointer border px-6 md:px-8 xl:px-10 py-2 rounded-full transition-all duration-300 border-gray-400 hover:bg-[#FF3377] hover:text-white hover:border-pink-900 peer-checked/ShippingTransaction:bg-[#FF3377] peer-checked/ShippingTransaction:text-white peer-checked/ShippingTransaction:border-pink-900">
                                        <div class="cFShippingTransaction">
                            ...
                            <div class="ctr-filterItm">
                                <div class="cFilterItm">
                                    <input type="radio" name="filterTransaction" id="filterItmRejectedTransaction" class="peer/RejectedTransaction hidden sr-only">
                                    <label for="filterItmRejectedTransaction" class="block cursor-pointer border px-6 md:px-8 xl:px-10 py-2 rounded-full transition-all duration-300 border-gray-400 hover:bg-[#FF3377] hover:text-white hover:border-pink-900 peer-checked/RejectedTransaction:bg-[#FF3377] peer-checked/RejectedTransaction:text-white peer-checked/RejectedTransaction:border-pink-900">
                                        <div class="cFRejectedTransaction">
