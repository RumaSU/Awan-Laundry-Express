                                    ...
                                    <div class="ctr-headPromoItm">
                                        <div class="cHeadPromoItm flex items-center justify-between selectDisable">
                                            <div class="ctr-lftEdit relative hover:brightness-90">
                                                <div class="cLftEdit px-4 md:px-8 py-2 text-xs md:text-sm text-gray-800 bg-[#D9D9D9] rounded-lg" data-promoId="{{ $uuidThis }}">
                                                    <div class="tx">
                                                        <strong>Edit</strong>
                                                    </div>
                                                </div>
...
@section('popup-content-field')
    ...
    <div class="ctr-shwMdlDetPromo p-2 h-[100vh] md:h-[80vh] overflow-hidden bg-white md:rounded-2xl md:shadow-lg md:shadow-black/50 transition-all fixed z-[100] w-full md:w-[640px]" style="left: 50%; top: 50%; transform: translate(-50%, -50%);">
